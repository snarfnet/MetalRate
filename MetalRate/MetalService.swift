...
final class MetalService {
    ...
    private static func makeDefaultMetals() -> [MetalInfo] {
        [
            MetalInfo(id: "gold", name: "金", nameEn: "Gold", symbol: "XAU", category: .precious),
            MetalInfo(id: "silver", name: "銀", nameEn: "Silver", symbol: "XAG", category: .precious),
            MetalInfo(id: "platinum", name: "プラチナ", nameEn: "Platinum", symbol: "XPT", category: .precious),
            MetalInfo(id: "palladium", name: "パラジウム", nameEn: "Palladium", symbol: "XPD", category: .precious),
            MetalInfo(id: "copper", name: "銅", nameEn: "Copper", symbol: "Cu", category: .base, unit: "lb"),
            MetalInfo(id: "aluminum", name: "アルミニウム", nameEn: "Aluminum", symbol: "Al", category: .base, unit: "lb"),
            MetalInfo(id: "nickel", name: "ニッケル", nameEn: "Nickel", symbol: "Ni", category: .base, unit: "lb"),
            MetalInfo(id: "zinc", name: "亜鉛", nameEn: "Zinc", symbol: "Zn", category: .base, unit: "lb"),
            MetalInfo(id: "lead", name: "鉛", nameEn: "Lead", symbol: "Pb", category: .base, unit: "lb"),
            MetalInfo(id: "tin", name: "スズ", nameEn: "Tin", symbol: "Sn", category: .base, unit: "lb")
        ]
    }
